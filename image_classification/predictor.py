...
if __name__ == "__main__":
    """
    python predictor.py --predictor_config "specific/config/predictor_config.yaml"
    ...
    parser.add_argument(
        ...
        default="specific/config/prediction_config.yaml",
    )
    print(sys.path)
    ...
    #     "specific/data/0ab5f5ba8484483a8f8003c0152e181d.jpg"
    # )
    # print(pred)
    #
    # pred = predictor.predict_from_path(
